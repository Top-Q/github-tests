...
public @interface Find {
    ...
    class FindByBuilder extends PopFindByBuilder {
        /**
         * <p>Create the {@link By} locator from the given annotation.
         * <p>This method does special locator-building for {@link PopElement}s.
         *
        ...
        public By buildIt(Object annotation, Field field) {
            ...
            // If the type is subclass of P81Element
            if (PopElement.class.isAssignableFrom(type)) {
                Root rootLocator = type.getAnnotation(Root.class);
                if (rootLocator != null) {
                    ...
                    throw new IllegalStateException(type + " must be annotated with " + Root.class.getSimpleName());
                }
            }
